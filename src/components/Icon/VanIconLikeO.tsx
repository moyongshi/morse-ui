...
let VanIconLikeO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconLikeO.defaultProps = {
  size: 20,
};

VanIconLikeO = React.memo ? React.memo(VanIconLikeO) : VanIconLikeO;

export default VanIconLikeO;
