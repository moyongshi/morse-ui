...
let VanIconGem: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconGem.defaultProps = {
  size: 20,
};

VanIconGem = React.memo ? React.memo(VanIconGem) : VanIconGem;

export default VanIconGem;
