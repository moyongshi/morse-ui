...
let VanIconPlayCircle: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconPlayCircle.defaultProps = {
  size: 20,
};

VanIconPlayCircle = React.memo ? React.memo(VanIconPlayCircle) : VanIconPlayCircle;

export default VanIconPlayCircle;
