...
let VanIconMore: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconMore.defaultProps = {
  size: 20,
};

VanIconMore = React.memo ? React.memo(VanIconMore) : VanIconMore;

export default VanIconMore;
