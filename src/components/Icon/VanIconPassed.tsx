...
let VanIconPassed: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconPassed.defaultProps = {
  size: 20,
};

VanIconPassed = React.memo ? React.memo(VanIconPassed) : VanIconPassed;

export default VanIconPassed;
