...
let VanIconPendingPayment: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconPendingPayment.defaultProps = {
  size: 20,
};

VanIconPendingPayment = React.memo ? React.memo(VanIconPendingPayment) : VanIconPendingPayment;

export default VanIconPendingPayment;
