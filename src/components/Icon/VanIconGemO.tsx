...
let VanIconGemO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconGemO.defaultProps = {
  size: 20,
};

VanIconGemO = React.memo ? React.memo(VanIconGemO) : VanIconGemO;

export default VanIconGemO;
