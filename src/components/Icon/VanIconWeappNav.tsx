...
let VanIconWeappNav: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconWeappNav.defaultProps = {
  size: 20,
};

VanIconWeappNav = React.memo ? React.memo(VanIconWeappNav) : VanIconWeappNav;

export default VanIconWeappNav;
