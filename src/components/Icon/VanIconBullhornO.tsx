...
let VanIconBullhornO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconBullhornO.defaultProps = {
  size: 20,
};

VanIconBullhornO = React.memo ? React.memo(VanIconBullhornO) : VanIconBullhornO;

export default VanIconBullhornO;
