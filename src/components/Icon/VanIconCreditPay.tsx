...
let VanIconCreditPay: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconCreditPay.defaultProps = {
  size: 20,
};

VanIconCreditPay = React.memo ? React.memo(VanIconCreditPay) : VanIconCreditPay;

export default VanIconCreditPay;
