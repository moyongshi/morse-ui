...
let VanIconArrow: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconArrow.defaultProps = {
  size: 20,
};

VanIconArrow = React.memo ? React.memo(VanIconArrow) : VanIconArrow;

export default VanIconArrow;
