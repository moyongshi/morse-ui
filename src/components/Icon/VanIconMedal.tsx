...
let VanIconMedal: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconMedal.defaultProps = {
  size: 20,
};

VanIconMedal = React.memo ? React.memo(VanIconMedal) : VanIconMedal;

export default VanIconMedal;
