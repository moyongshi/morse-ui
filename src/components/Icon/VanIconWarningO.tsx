...
let VanIconWarningO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconWarningO.defaultProps = {
  size: 20,
};

VanIconWarningO = React.memo ? React.memo(VanIconWarningO) : VanIconWarningO;

export default VanIconWarningO;
