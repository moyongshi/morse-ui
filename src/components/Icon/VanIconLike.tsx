...
let VanIconLike: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconLike.defaultProps = {
  size: 20,
};

VanIconLike = React.memo ? React.memo(VanIconLike) : VanIconLike;

export default VanIconLike;
