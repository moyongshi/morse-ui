...
let VanIconAdd: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconAdd.defaultProps = {
  size: 20,
};

VanIconAdd = React.memo ? React.memo(VanIconAdd) : VanIconAdd;

export default VanIconAdd;
