...
let VanIconCart: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconCart.defaultProps = {
  size: 20,
};

VanIconCart = React.memo ? React.memo(VanIconCart) : VanIconCart;

export default VanIconCart;
