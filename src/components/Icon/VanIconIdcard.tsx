...
let VanIconIdcard: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconIdcard.defaultProps = {
  size: 20,
};

VanIconIdcard = React.memo ? React.memo(VanIconIdcard) : VanIconIdcard;

export default VanIconIdcard;
