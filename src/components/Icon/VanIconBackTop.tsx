...
let VanIconBackTop: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconBackTop.defaultProps = {
  size: 20,
};

VanIconBackTop = React.memo ? React.memo(VanIconBackTop) : VanIconBackTop;

export default VanIconBackTop;
