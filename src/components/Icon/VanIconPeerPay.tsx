...
let VanIconPeerPay: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconPeerPay.defaultProps = {
  size: 20,
};

VanIconPeerPay = React.memo ? React.memo(VanIconPeerPay) : VanIconPeerPay;

export default VanIconPeerPay;
