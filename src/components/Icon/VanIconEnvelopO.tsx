...
let VanIconEnvelopO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconEnvelopO.defaultProps = {
  size: 20,
};

VanIconEnvelopO = React.memo ? React.memo(VanIconEnvelopO) : VanIconEnvelopO;

export default VanIconEnvelopO;
