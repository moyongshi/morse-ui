...
let VanIconDiamondO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconDiamondO.defaultProps = {
  size: 20,
};

VanIconDiamondO = React.memo ? React.memo(VanIconDiamondO) : VanIconDiamondO;

export default VanIconDiamondO;
