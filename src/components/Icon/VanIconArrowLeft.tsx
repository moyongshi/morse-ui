...
let VanIconArrowLeft: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconArrowLeft.defaultProps = {
  size: 20,
};

VanIconArrowLeft = React.memo ? React.memo(VanIconArrowLeft) : VanIconArrowLeft;

export default VanIconArrowLeft;
