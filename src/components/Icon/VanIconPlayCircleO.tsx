...
let VanIconPlayCircleO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconPlayCircleO.defaultProps = {
  size: 20,
};

VanIconPlayCircleO = React.memo ? React.memo(VanIconPlayCircleO) : VanIconPlayCircleO;

export default VanIconPlayCircleO;
