...
let VanIconFail: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconFail.defaultProps = {
  size: 20,
};

VanIconFail = React.memo ? React.memo(VanIconFail) : VanIconFail;

export default VanIconFail;
