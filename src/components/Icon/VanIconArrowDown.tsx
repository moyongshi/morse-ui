...
let VanIconArrowDown: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconArrowDown.defaultProps = {
  size: 20,
};

VanIconArrowDown = React.memo ? React.memo(VanIconArrowDown) : VanIconArrowDown;

export default VanIconArrowDown;
