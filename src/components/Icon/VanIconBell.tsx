...
let VanIconBell: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconBell.defaultProps = {
  size: 20,
};

VanIconBell = React.memo ? React.memo(VanIconBell) : VanIconBell;

export default VanIconBell;
