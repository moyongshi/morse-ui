...
let VanIconWechatPay: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconWechatPay.defaultProps = {
  size: 20,
};

VanIconWechatPay = React.memo ? React.memo(VanIconWechatPay) : VanIconWechatPay;

export default VanIconWechatPay;
