...
let VanIconLabelO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconLabelO.defaultProps = {
  size: 20,
};

VanIconLabelO = React.memo ? React.memo(VanIconLabelO) : VanIconLabelO;

export default VanIconLabelO;
