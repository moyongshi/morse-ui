...
let VanIconFire: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconFire.defaultProps = {
  size: 20,
};

VanIconFire = React.memo ? React.memo(VanIconFire) : VanIconFire;

export default VanIconFire;
