...
let VanIconEye: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconEye.defaultProps = {
  size: 20,
};

VanIconEye = React.memo ? React.memo(VanIconEye) : VanIconEye;

export default VanIconEye;
