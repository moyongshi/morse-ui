...
let VanIconInfoO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconInfoO.defaultProps = {
  size: 20,
};

VanIconInfoO = React.memo ? React.memo(VanIconInfoO) : VanIconInfoO;

export default VanIconInfoO;
