...
let VanIconUpgrade: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconUpgrade.defaultProps = {
  size: 20,
};

VanIconUpgrade = React.memo ? React.memo(VanIconUpgrade) : VanIconUpgrade;

export default VanIconUpgrade;
