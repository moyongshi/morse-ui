...
let VanIconCross: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconCross.defaultProps = {
  size: 20,
};

VanIconCross = React.memo ? React.memo(VanIconCross) : VanIconCross;

export default VanIconCross;
