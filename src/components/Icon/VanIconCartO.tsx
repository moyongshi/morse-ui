...
let VanIconCartO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconCartO.defaultProps = {
  size: 20,
};

VanIconCartO = React.memo ? React.memo(VanIconCartO) : VanIconCartO;

export default VanIconCartO;
