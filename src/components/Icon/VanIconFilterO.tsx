...
let VanIconFilterO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconFilterO.defaultProps = {
  size: 20,
};

VanIconFilterO = React.memo ? React.memo(VanIconFilterO) : VanIconFilterO;

export default VanIconFilterO;
