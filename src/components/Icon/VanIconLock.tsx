...
let VanIconLock: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconLock.defaultProps = {
  size: 20,
};

VanIconLock = React.memo ? React.memo(VanIconLock) : VanIconLock;

export default VanIconLock;
