...
let VanIconManager: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconManager.defaultProps = {
  size: 20,
};

VanIconManager = React.memo ? React.memo(VanIconManager) : VanIconManager;

export default VanIconManager;
