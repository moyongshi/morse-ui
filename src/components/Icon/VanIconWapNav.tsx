...
let VanIconWapNav: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconWapNav.defaultProps = {
  size: 20,
};

VanIconWapNav = React.memo ? React.memo(VanIconWapNav) : VanIconWapNav;

export default VanIconWapNav;
