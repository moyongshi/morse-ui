...
let VanIconCommentCircle: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconCommentCircle.defaultProps = {
  size: 20,
};

VanIconCommentCircle = React.memo ? React.memo(VanIconCommentCircle) : VanIconCommentCircle;

export default VanIconCommentCircle;
