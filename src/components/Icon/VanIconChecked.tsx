...
let VanIconChecked: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconChecked.defaultProps = {
  size: 20,
};

VanIconChecked = React.memo ? React.memo(VanIconChecked) : VanIconChecked;

export default VanIconChecked;
