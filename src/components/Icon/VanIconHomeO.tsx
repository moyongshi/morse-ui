...
let VanIconHomeO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconHomeO.defaultProps = {
  size: 20,
};

VanIconHomeO = React.memo ? React.memo(VanIconHomeO) : VanIconHomeO;

export default VanIconHomeO;
