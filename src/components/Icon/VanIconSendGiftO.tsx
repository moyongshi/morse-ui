...
let VanIconSendGiftO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconSendGiftO.defaultProps = {
  size: 20,
};

VanIconSendGiftO = React.memo ? React.memo(VanIconSendGiftO) : VanIconSendGiftO;

export default VanIconSendGiftO;
