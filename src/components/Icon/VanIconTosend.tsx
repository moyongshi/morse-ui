...
let VanIconTosend: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconTosend.defaultProps = {
  size: 20,
};

VanIconTosend = React.memo ? React.memo(VanIconTosend) : VanIconTosend;

export default VanIconTosend;
