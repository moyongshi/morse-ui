...
let VanIconSearch: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconSearch.defaultProps = {
  size: 20,
};

VanIconSearch = React.memo ? React.memo(VanIconSearch) : VanIconSearch;

export default VanIconSearch;
