...
let VanIconClockO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconClockO.defaultProps = {
  size: 20,
};

VanIconClockO = React.memo ? React.memo(VanIconClockO) : VanIconClockO;

export default VanIconClockO;
