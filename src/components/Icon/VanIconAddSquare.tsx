...
let VanIconAddSquare: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconAddSquare.defaultProps = {
  size: 20,
};

VanIconAddSquare = React.memo ? React.memo(VanIconAddSquare) : VanIconAddSquare;

export default VanIconAddSquare;
