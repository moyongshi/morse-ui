...
let VanIconBag: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconBag.defaultProps = {
  size: 20,
};

VanIconBag = React.memo ? React.memo(VanIconBag) : VanIconBag;

export default VanIconBag;
