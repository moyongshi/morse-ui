...
let VanIconPhoto: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconPhoto.defaultProps = {
  size: 20,
};

VanIconPhoto = React.memo ? React.memo(VanIconPhoto) : VanIconPhoto;

export default VanIconPhoto;
