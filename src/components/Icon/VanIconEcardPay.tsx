...
let VanIconEcardPay: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconEcardPay.defaultProps = {
  size: 20,
};

VanIconEcardPay = React.memo ? React.memo(VanIconEcardPay) : VanIconEcardPay;

export default VanIconEcardPay;
