...
let VanIconShoppingCart: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconShoppingCart.defaultProps = {
  size: 20,
};

VanIconShoppingCart = React.memo ? React.memo(VanIconShoppingCart) : VanIconShoppingCart;

export default VanIconShoppingCart;
