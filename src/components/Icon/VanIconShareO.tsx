...
let VanIconShareO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconShareO.defaultProps = {
  size: 20,
};

VanIconShareO = React.memo ? React.memo(VanIconShareO) : VanIconShareO;

export default VanIconShareO;
