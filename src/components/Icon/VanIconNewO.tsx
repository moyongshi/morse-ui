...
let VanIconNewO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconNewO.defaultProps = {
  size: 20,
};

VanIconNewO = React.memo ? React.memo(VanIconNewO) : VanIconNewO;

export default VanIconNewO;
