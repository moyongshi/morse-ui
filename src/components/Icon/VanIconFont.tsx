...
let VanIconFont: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconFont.defaultProps = {
  size: 20,
};

VanIconFont = React.memo ? React.memo(VanIconFont) : VanIconFont;

export default VanIconFont;
