...
let VanIconArrowUp: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconArrowUp.defaultProps = {
  size: 20,
};

VanIconArrowUp = React.memo ? React.memo(VanIconArrowUp) : VanIconArrowUp;

export default VanIconArrowUp;
