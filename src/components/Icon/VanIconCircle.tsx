...
let VanIconCircle: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconCircle.defaultProps = {
  size: 20,
};

VanIconCircle = React.memo ? React.memo(VanIconCircle) : VanIconCircle;

export default VanIconCircle;
