...
let VanIconContact: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconContact.defaultProps = {
  size: 20,
};

VanIconContact = React.memo ? React.memo(VanIconContact) : VanIconContact;

export default VanIconContact;
