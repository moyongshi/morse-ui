...
let VanIconMoreO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconMoreO.defaultProps = {
  size: 20,
};

VanIconMoreO = React.memo ? React.memo(VanIconMoreO) : VanIconMoreO;

export default VanIconMoreO;
