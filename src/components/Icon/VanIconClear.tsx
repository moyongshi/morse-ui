...
let VanIconClear: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconClear.defaultProps = {
  size: 20,
};

VanIconClear = React.memo ? React.memo(VanIconClear) : VanIconClear;

export default VanIconClear;
