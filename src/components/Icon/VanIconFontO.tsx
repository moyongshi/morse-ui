...
let VanIconFontO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconFontO.defaultProps = {
  size: 20,
};

VanIconFontO = React.memo ? React.memo(VanIconFontO) : VanIconFontO;

export default VanIconFontO;
