...
let VanIconShoppingCartO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconShoppingCartO.defaultProps = {
  size: 20,
};

VanIconShoppingCartO = React.memo ? React.memo(VanIconShoppingCartO) : VanIconShoppingCartO;

export default VanIconShoppingCartO;
