...
let VanIconCommentO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconCommentO.defaultProps = {
  size: 20,
};

VanIconCommentO = React.memo ? React.memo(VanIconCommentO) : VanIconCommentO;

export default VanIconCommentO;
