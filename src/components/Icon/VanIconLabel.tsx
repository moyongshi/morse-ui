...
let VanIconLabel: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconLabel.defaultProps = {
  size: 20,
};

VanIconLabel = React.memo ? React.memo(VanIconLabel) : VanIconLabel;

export default VanIconLabel;
