...
let VanIconUnderwayO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconUnderwayO.defaultProps = {
  size: 20,
};

VanIconUnderwayO = React.memo ? React.memo(VanIconUnderwayO) : VanIconUnderwayO;

export default VanIconUnderwayO;
