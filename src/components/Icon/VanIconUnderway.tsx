...
let VanIconUnderway: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconUnderway.defaultProps = {
  size: 20,
};

VanIconUnderway = React.memo ? React.memo(VanIconUnderway) : VanIconUnderway;

export default VanIconUnderway;
