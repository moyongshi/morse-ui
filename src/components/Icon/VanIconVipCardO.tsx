...
let VanIconVipCardO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconVipCardO.defaultProps = {
  size: 20,
};

VanIconVipCardO = React.memo ? React.memo(VanIconVipCardO) : VanIconVipCardO;

export default VanIconVipCardO;
