...
let VanIconWapHome: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconWapHome.defaultProps = {
  size: 20,
};

VanIconWapHome = React.memo ? React.memo(VanIconWapHome) : VanIconWapHome;

export default VanIconWapHome;
