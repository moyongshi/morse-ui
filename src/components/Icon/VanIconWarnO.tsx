...
let VanIconWarnO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconWarnO.defaultProps = {
  size: 20,
};

VanIconWarnO = React.memo ? React.memo(VanIconWarnO) : VanIconWarnO;

export default VanIconWarnO;
