...
let VanIconPlay: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconPlay.defaultProps = {
  size: 20,
};

VanIconPlay = React.memo ? React.memo(VanIconPlay) : VanIconPlay;

export default VanIconPlay;
