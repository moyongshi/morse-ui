...
let VanIconCard: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconCard.defaultProps = {
  size: 20,
};

VanIconCard = React.memo ? React.memo(VanIconCard) : VanIconCard;

export default VanIconCard;
