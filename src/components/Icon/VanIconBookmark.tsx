...
let VanIconBookmark: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconBookmark.defaultProps = {
  size: 20,
};

VanIconBookmark = React.memo ? React.memo(VanIconBookmark) : VanIconBookmark;

export default VanIconBookmark;
