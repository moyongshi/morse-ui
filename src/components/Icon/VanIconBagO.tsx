...
let VanIconBagO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconBagO.defaultProps = {
  size: 20,
};

VanIconBagO = React.memo ? React.memo(VanIconBagO) : VanIconBagO;

export default VanIconBagO;
