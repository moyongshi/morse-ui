...
let VanIconAward: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconAward.defaultProps = {
  size: 20,
};

VanIconAward = React.memo ? React.memo(VanIconAward) : VanIconAward;

export default VanIconAward;
