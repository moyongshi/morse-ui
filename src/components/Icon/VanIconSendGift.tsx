...
let VanIconSendGift: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconSendGift.defaultProps = {
  size: 20,
};

VanIconSendGift = React.memo ? React.memo(VanIconSendGift) : VanIconSendGift;

export default VanIconSendGift;
