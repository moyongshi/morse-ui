...
let VanIconCommentCircleO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconCommentCircleO.defaultProps = {
  size: 20,
};

VanIconCommentCircleO = React.memo ? React.memo(VanIconCommentCircleO) : VanIconCommentCircleO;

export default VanIconCommentCircleO;
