...
let VanIconBrowsingHistory: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconBrowsingHistory.defaultProps = {
  size: 20,
};

VanIconBrowsingHistory = React.memo ? React.memo(VanIconBrowsingHistory) : VanIconBrowsingHistory;

export default VanIconBrowsingHistory;
