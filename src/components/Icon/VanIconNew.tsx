...
let VanIconNew: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconNew.defaultProps = {
  size: 20,
};

VanIconNew = React.memo ? React.memo(VanIconNew) : VanIconNew;

export default VanIconNew;
