...
let VanIconDown: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconDown.defaultProps = {
  size: 20,
};

VanIconDown = React.memo ? React.memo(VanIconDown) : VanIconDown;

export default VanIconDown;
