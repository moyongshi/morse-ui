...
let VanIconPhotograph: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconPhotograph.defaultProps = {
  size: 20,
};

VanIconPhotograph = React.memo ? React.memo(VanIconPhotograph) : VanIconPhotograph;

export default VanIconPhotograph;
