...
let VanIconWarning: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconWarning.defaultProps = {
  size: 20,
};

VanIconWarning = React.memo ? React.memo(VanIconWarning) : VanIconWarning;

export default VanIconWarning;
