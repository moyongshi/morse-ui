...
let VanIconStar: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconStar.defaultProps = {
  size: 20,
};

VanIconStar = React.memo ? React.memo(VanIconStar) : VanIconStar;

export default VanIconStar;
