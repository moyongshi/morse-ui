...
let VanIconPrinter: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconPrinter.defaultProps = {
  size: 20,
};

VanIconPrinter = React.memo ? React.memo(VanIconPrinter) : VanIconPrinter;

export default VanIconPrinter;
