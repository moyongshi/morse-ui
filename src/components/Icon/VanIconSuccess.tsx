...
let VanIconSuccess: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconSuccess.defaultProps = {
  size: 20,
};

VanIconSuccess = React.memo ? React.memo(VanIconSuccess) : VanIconSuccess;

export default VanIconSuccess;
