...
let VanIconEdit: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconEdit.defaultProps = {
  size: 20,
};

VanIconEdit = React.memo ? React.memo(VanIconEdit) : VanIconEdit;

export default VanIconEdit;
