...
let VanIconEllipsis: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconEllipsis.defaultProps = {
  size: 20,
};

VanIconEllipsis = React.memo ? React.memo(VanIconEllipsis) : VanIconEllipsis;

export default VanIconEllipsis;
