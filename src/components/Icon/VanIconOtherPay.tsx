...
let VanIconOtherPay: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconOtherPay.defaultProps = {
  size: 20,
};

VanIconOtherPay = React.memo ? React.memo(VanIconOtherPay) : VanIconOtherPay;

export default VanIconOtherPay;
