...
let VanIconComment: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconComment.defaultProps = {
  size: 20,
};

VanIconComment = React.memo ? React.memo(VanIconComment) : VanIconComment;

export default VanIconComment;
