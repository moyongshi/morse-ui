...
let VanIconChatO: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconChatO.defaultProps = {
  size: 20,
};

VanIconChatO = React.memo ? React.memo(VanIconChatO) : VanIconChatO;

export default VanIconChatO;
