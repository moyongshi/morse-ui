...
let VanIconPlus: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconPlus.defaultProps = {
  size: 20,
};

VanIconPlus = React.memo ? React.memo(VanIconPlus) : VanIconPlus;

export default VanIconPlus;
