...
let VanIconVipCard: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
VanIconVipCard.defaultProps = {
  size: 20,
};

VanIconVipCard = React.memo ? React.memo(VanIconVipCard) : VanIconVipCard;

export default VanIconVipCard;
